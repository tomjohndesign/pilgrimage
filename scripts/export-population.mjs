...
try {
  ...
  exporting = true
  const pack = await page.evaluate(jobs => jobs ? window.__jobBake(window.__reportPopulationProgress) : window.__bakePersonPopulation(window.__reportPopulationProgress), jobs)
