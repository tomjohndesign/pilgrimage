...
import { SpritePipeline } from "@/components/sprite-pipeline"

export const metadata: Metadata = {
  title: "Pilgrimage — Sprite pipeline",
  description: "One figure through every stage of the bake: primitives, rig, colour, ink, depth and shadow.",
}

export default function SpritePipelinePage() {
  return (
    <main className="flex min-h-screen flex-col items-center bg-[#1a1208] px-5 py-14">
      <header className="mb-10 text-center">
        ...
        <p className="mt-3 font-display text-[10px] uppercase tracking-[3px] text-gold">
          One figure · Every stage of the bake
        </p>
      </header>
