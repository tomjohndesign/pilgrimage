...
describe("simulation save", () => {
  it("survives a JSON round trip and keeps everyone's lasting state", () => {
    ...
    sim.foodStores.set(camp, { grain: 4, vegetables: 0, fruit: 1, fish: 0, meat: 4, milk: 12, eggs: 3 })
    ...
    expect(fresh.foodStores.get(camp)).toEqual({ grain: 4, vegetables: 0, fruit: 1, fish: 0, meat: 4, milk: 12, eggs: 3 })
