...
export async function bakeRocketMonks() {
  ...
  return { images, metadata: { version: 16, reservedTones: true, depthEncoding: SPRITE_DEPTH_ENCODING, templateVersion: BASE_PERSON.version, cellSize: BASE_PERSON.cellSize,
