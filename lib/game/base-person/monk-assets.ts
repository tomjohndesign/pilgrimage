import greyManifest from "../../../public/textures/characters/monks/v45/manifest.json"
import { GREY_HAIR_AGE } from "../character-age"
import manifest from "../../../public/textures/characters/monks/v44/manifest.json"
...
function visualForMonk(manifest: typeof greyManifest): ReturnType<typeof populationVisual> {
  return {
    ...
    actions: Object.fromEntries(ACTION_CLIPS.filter((clip): clip is keyof typeof manifest.images.actions => clip in manifest.images.actions).map(clip => [clip, {
