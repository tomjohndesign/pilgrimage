...
export const recipeSchema = z.object({
  ...
  variant: z.enum(["alms-table", "inn", "enclosure", "monk-shelter", "house", "storehouse", "wood-shelter", "tavern", "shelter", "workshop", "garden", "cross", "hall", "lumberCamp", "market", "guard-post", "sheep-pen", "chicken-coop", "gable", "hipped", "porch"]),
