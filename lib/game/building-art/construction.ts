...
export function constructionParts(building: BuildingDef & Pick<StructureAppearance, "stocked" | "churchWing">, roofJoins: RoofJoin[] = [], finished = structureParts(building, roofJoins)): BuildingPart[] {
