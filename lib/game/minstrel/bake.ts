...
export async function bakeMinstrels() {
  ...
  return { image: canvas.toDataURL(), depth: depth.toDataURL(), metadata: { version: 4, reservedTones: true, depthEncoding: SPRITE_DEPTH_ENCODING, templateVersion: BASE_PERSON.version,
