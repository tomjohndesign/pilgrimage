...
it("uses distinct red resource icons while retaining golden income labels", () => {
  const income = paymentLabel(45), gold = paymentLabel(45, "gold"), wood = paymentLabel(35, "wood")
  ...
  expect(colors(income)).toContain("255,216,106,255")
  ...
  for (const texture of [income, gold, wood]) texture.dispose()
})
