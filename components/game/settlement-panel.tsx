  ...
  return (
    <section className="hud-inspector-content text-ink">
      ...
      <p className="mb-2 text-[11px] text-ink-light">
        {economy.visits} visits · {economy.residents.length - monks.length} settlers · {Math.max(0, map.buildings.filter((b) => b.buildType === "workshop").length * 3 - (economy.residents.length - monks.length))} open jobs
      </p>
      <details>
