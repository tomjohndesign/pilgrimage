...
export function AnimalPreview({ pack = false, subject, lineup, motion, playing, row, zoom, rate, coat, horseVariant, onSelect, directionCanvases, showRig, construction, frame: inspectedFrame, edits, joints, selected, onInspect, onJoint, onPose, onDrag }: {
  pack?: boolean; subject: AnimalSubject; lineup: boolean; motion: AnimalMotion; playing: boolean; row: number; zoom: number; rate: number; coat: string; horseVariant: HorseVariant; onSelect: (subject: AnimalSubject) => void
  ...
  }, [subject, lineup, coat, horseVariant, pack, directionCanvases, construction])
