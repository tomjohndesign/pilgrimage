    ...
    <article className="mb-8 border border-rule bg-parchment p-5 text-ink">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div><h3 className="font-display text-lg">Base person · shared template</h3><p className="mt-2 text-sm text-ink-light">Storybook ~35px figures · 64px padded cells · custom colour palette · eight directions</p>
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-xs underline underline-offset-4"><Link href="/assets/characters">Inspect the base →</Link><a href="/textures/characters/base/base-person-v20-walk.png" download>Walk sheet</a><a href="/textures/characters/base/base-person-v20-idle.png" download>Idle sheet</a><a href="/textures/characters/base/base-person-v20.json" download>Attachment data</a><a href="/textures/characters/base/base-person-v20-shadow-walk.png" download>Shadow sheet</a></div>
        </div>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/textures/characters/base/base-person-v20-walk.png" width={1280} height={512} alt="Shared base person, 160 walk poses at native resolution" className="max-w-full bg-[#62724d]" style={{ imageRendering: "pixelated" }} />
      </div>
    </article>
