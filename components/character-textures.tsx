    ...
    <article className="mb-8 border border-rule bg-parchment p-5 text-ink">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div><h3 className="font-display text-lg">Base person · shared template</h3><p className="mt-2 text-sm text-ink-light">Storybook ~35px figures · 64px padded cells · custom colour palette · eight directions</p>
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-xs underline underline-offset-4"><Link href="/assets/characters">Inspect the base →</Link><a href="/textures/characters/base/base-person-v25-walk.png" download>Walk sheet</a><a href="/textures/characters/base/base-person-v25-idle.png" download>Idle sheet</a><a href="/textures/characters/base/base-person-v25.json" download>Attachment data</a><a href="/textures/characters/base/base-person-v25-shadow-walk.png" download>Shadow sheet</a></div>
        </div>
